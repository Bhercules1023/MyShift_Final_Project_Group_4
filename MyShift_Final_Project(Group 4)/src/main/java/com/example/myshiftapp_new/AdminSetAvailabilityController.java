...
public class AdminSetAvailabilityController {
    ...
    private void addAvailability(){
        ...
        String addAvailability = "INSERT INTO ManagementAvailability (ManagementID, Sunday, Monday, " +
                "Tuesday, Wednesday, " +
    ...
    private void updateAvailability() {
        ...
        String updateAvailability = "UPDATE ManagementAvailability SET Sunday = ?, Monday = ?, Tuesday = ?," +
    ...
    private void displayAvailability(){
        ...
        User currentUser = CurrentUser.getInstance().getLoggedInUser();
        String getAvailability = "SELECT * FROM ManagementAvailability WHERE ManagementID = ?";
    ...
    private void checkExistingAvailability(){
        ...
        String checkRecord = "SELECT * FROM ManagementAvailability WHERE ManagementID = ?";
