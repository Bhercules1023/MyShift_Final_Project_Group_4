...
public class AdminNotesController {
    ...
    private ObservableList<String> ManagementNotesList = FXCollections.observableArrayList();
    ...
    private void handleAddNotes(){
        ...
        String insertNote = "INSERT INTO ManagementNotes(ManagementID, NoteContent) VALUES(?,?)";
    ...
    private void handleDeleteNotes(){
        ...
        String deleteNote = "DELETE FROM ManagementNotes WHERE ManagementID = ? AND NoteContent = ?";
        ...
        try (Connection connect = new DatabaseConnection().getConnection();
            ...
            ManagementNotesList.remove(selectedNote);
            addNotes.clear();
        }
        catch (Exception e){
            e.printStackTrace();
    ...
    private void refreshNotesList(){
        ...
        String readNotes = "SELECT NoteContent FROM ManagementNotes WHERE ManagementID = ?";
    ...
    private void initialize() throws IOException {
        refreshNotesList();
        displayNotes.setItems(ManagementNotesList);
